    ...
    <div class="login-container">
        ...
        <form method="POST" action="<?php echo e(route('admin.login')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" class="form-control" value="<?php echo e(old('username')); ?>" required autofocus>
            </div>
...
<?php /**PATH C:\Users\Administrator\Documents\bot\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Админ-панель'); ?> - Dota 2 Quiz Bot</title>
    <style>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">📊 Панель управления</a></li>
            <li><a href="<?php echo e(route('admin.questions.index')); ?>" class="<?php echo e(request()->routeIs('admin.questions.*') ? 'active' : ''); ?>">❓ Вопросы</a></li>
            <li><a href="<?php echo e(route('admin.statistics.index')); ?>" class="<?php echo e(request()->routeIs('admin.statistics.*') ? 'active' : ''); ?>">📈 Статистика</a></li>
            <li><a href="<?php echo e(route('admin.chats.index')); ?>" class="<?php echo e(request()->routeIs('admin.chats.*') ? 'active' : ''); ?>">💬 Чаты</a></li>
        </ul>
    </div>
    <?php endif; ?>

    <div class="main-content" style="<?php echo e(Auth::guard('admin')->check() ? '' : 'margin-left: 0;'); ?>">
        <?php if(auth()->guard('admin')->check()): ?>
        <div class="header">
            <h1><?php echo $__env->yieldContent('page-title', 'Панель управления'); ?></h1>
            <div class="user-menu">
                <span><?php echo e(Auth::guard('admin')->user()->name ?? Auth::guard('admin')->user()->username); ?></span>
...
<?php /**PATH C:\Users\Administrator\Documents\bot\resources\views/admin/layout.blade.php ENDPATH**/ ?>